    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                The "Anyone But Cuomo" (ABC) campaign was created by a coalition of progressive organizations 
                and activists who believe that New York City deserves a mayor who will fight for working-class 
                New Yorkers, not corporate interests.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Andrew Cuomo's entry into the mayoral race has raised concerns among progressive organizations 
                and activists who have witnessed his track record as governor of New York.
              </p>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="border-l-4 border-red-500 pl-4">
                  <h4 className="font-bold mb-2">Blocking Progressive Legislation</h4>
                  <p className="text-gray-600">
                    Cuomo repeatedly obstructed progressive legislation, including tenant protections, 
                    healthcare reform, and climate action, often using the Independent Democratic Conference 
                    (IDC) to maintain Republican control of the state senate.
                  </p>
                </div>
              ...
              <p className="text-gray-600">
                ...
                advocating for voters to consider any of the progressive candidates featured in this guide 
                rather than Andrew Cuomo.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          <SectionHeader
            title="Get Involved"
            subtitle="Join the movement for a progressive NYC mayor."
            centered={true}
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                ...
                and candidates, the better our chances of electing a progressive mayor.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                Join one of the many grassroots organizations working to elect progressive candidates. 
