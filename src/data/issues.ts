...
export const issues: Issue[] = [
  {
    ...
    description: 'Policies to address the housing crisis, rent control, and tenant protections.',
    icon: 'Home',
  },
  {
    id: 'climate',
  ...
  },
  {
    ...
    description: 'Approaches to public safety, police reform, and criminal justice.',
    icon: 'Shield',
  },
  {
    id: 'transportation',
