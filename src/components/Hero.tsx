        ...
        {(ctaText || secondaryCtaText) && (
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            {ctaText && ctaLink && (
              <Link
                href={ctaLink}
                className="bg-white text-blue-700 hover:bg-blue-50 font-bold py-3 px-6 rounded-lg shadow-md transition-colors duration-300 flex items-center justify-center"
              >
                {ctaText}
