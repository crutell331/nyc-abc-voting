      ...
      <header className="bg-blue-600 text-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <nav className="flex flex-wrap justify-center gap-6">
            ...
            <Link href="/issues" className="hover:text-blue-200 transition-colors duration-200">
              Issues
            </Link>
            <Link href="/candidates" className="hover:text-blue-200 transition-colors duration-200">
              Candidates
            </Link>
            <Link href="/rank-choice" className="hover:text-blue-200 transition-colors duration-200">
              Rank Choice Voting
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/issues" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Issues
                  </Link>
                </li>
                <li>
                  <Link href="/candidates" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Candidates
                  </Link>
                </li>
                <li>
                  <Link href="/rank-choice" className="text-gray-300 hover:text-white transition-colors duration-200">
                    Rank Choice Voting
                  </Link>
                </li>
              </ul>
